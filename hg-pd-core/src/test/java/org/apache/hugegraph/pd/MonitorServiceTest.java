...
public class MonitorServiceTest {
    ...
    public void testPatrolStores() throws PDException, InterruptedException {
        ...
        PartitionService partitionService = new PartitionService(pdConfig, storeService, configService);
        var monitorService = new TaskScheduleService(pdConfig, storeService, partitionService, configService);
