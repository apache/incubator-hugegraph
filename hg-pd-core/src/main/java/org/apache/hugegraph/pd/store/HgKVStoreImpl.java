<<<<<<<< HEAD:hugegraph-pd/hg-pd-core/src/main/java/org/apache/hugegraph/pd/store/HgKVStoreImpl.java
/*
...
import org.rocksdb.*;
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-core/src/main/java/org/apache/hugegraph/pd/store/HgKVStoreImpl.java
...
public class HgKVStoreImpl implements HgKVStore {
    ...
    public long remove(byte[] key) throws PDException {
        ...
        try {
            ...
            throw new PDException(ErrorType.ROCKSDB_DEL_ERROR_VALUE, e);
        } finally {
            readLock.unlock();
        }
        return 0;
...
<<<<<<<< HEAD:hugegraph-pd/hg-pd-core/src/main/java/org/apache/hugegraph/pd/store/HgKVStoreImpl.java
                throw new PDException(Pdpb.ErrorType.ROCKSDB_SAVE_SNAPSHOT_ERROR_VALUE,
                                      String.format("Fail to rename %s to %s", tempPath,
                                                    snapshotPath));
========
                throw new PDException(ErrorType.ROCKSDB_SAVE_SNAPSHOT_ERROR_VALUE,
...
<<<<<<<< HEAD:hugegraph-pd/hg-pd-core/src/main/java/org/apache/hugegraph/pd/store/HgKVStoreImpl.java
                throw new PDException(Pdpb.ErrorType.ROCKSDB_LOAD_SNAPSHOT_ERROR_VALUE,
                                      String.format("Fail to rename %s to %s", snapshotPath,
                                                    this.dbPath));
========
                throw new PDException(ErrorType.ROCKSDB_LOAD_SNAPSHOT_ERROR_VALUE,
