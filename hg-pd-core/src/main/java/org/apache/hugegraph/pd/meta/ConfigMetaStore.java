<<<<<<<< HEAD:hugegraph-pd/hg-pd-core/src/main/java/org/apache/hugegraph/pd/meta/ConfigMetaStore.java
/*
...
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-core/src/main/java/org/apache/hugegraph/pd/meta/ConfigMetaStore.java
...
<<<<<<<< HEAD:hugegraph-pd/hg-pd-core/src/main/java/org/apache/hugegraph/pd/meta/ConfigMetaStore.java
========
    public Metapb.StoreGroup saveStoreGroup(Metapb.StoreGroup storeGroup) throws PDException {
        byte[] graphSpaceKey = MetadataKeyHelper.getStoreGroupKey(storeGroup.getGroupId());
        put(graphSpaceKey, storeGroup.toByteArray());
        return storeGroup;
    }

    public Metapb.StoreGroup getStoreGroup(int groupId) throws PDException {
        byte[] graphSpaceKey = MetadataKeyHelper.getStoreGroupKey(groupId);
        return getOne(Metapb.StoreGroup.parser(), graphSpaceKey);
    }

    public List<Metapb.StoreGroup> getStoreGroups() throws PDException {
        byte[] graphSpaceKey = MetadataKeyHelper.getStoreGroupPrefix();
        return scanPrefix(Metapb.StoreGroup.parser(), graphSpaceKey);
    }
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-core/src/main/java/org/apache/hugegraph/pd/meta/ConfigMetaStore.java
}
