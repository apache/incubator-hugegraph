<<<<<<<< HEAD:hugegraph-pd/hg-pd-core/src/main/java/org/apache/hugegraph/pd/store/RaftKVStore.java
/*
...
import org.apache.hugegraph.pd.raft.RaftStateMachine.RaftClosureAdapter;
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-core/src/main/java/org/apache/hugegraph/pd/store/RaftKVStore.java
...
========
            ...
            throw new PDException(ErrorType.UNKNOWN_VALUE, e.getMessage());
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-core/src/main/java/org/apache/hugegraph/pd/store/RaftKVStore.java
        }
    }
...
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-core/src/main/java/org/apache/hugegraph/pd/store/RaftKVStore.java
    ...
    private <T> CompletableFuture<T> applyOperation(final KVOperation op) throws PDException {
        ...
        try {
            ...
            task.setDone(new RaftClosureAdapter(op, new KVStoreClosure() {
                Object data;
<<<<<<<< HEAD:hugegraph-pd/hg-pd-core/src/main/java/org/apache/hugegraph/pd/store/RaftKVStore.java
                Pdpb.Error error;
...
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-core/src/main/java/org/apache/hugegraph/pd/store/RaftKVStore.java
                ...
                public void run(Status status) {
                    if (status.isOk()) {
                        ...
                        error = Errors.newBuilder().setType(type)
