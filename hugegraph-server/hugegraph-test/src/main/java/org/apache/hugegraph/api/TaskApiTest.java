...
public class TaskApiTest extends BaseApiTest {
    ...
    private static final String PATH = "/graphspaces/DEFAULT/graphs/hugegraphapi/tasks/";
    ...
    private int rebuild() {
        ...
        String rebuildPath = "/graphspaces/DEFAULT/graphs/hugegraphapi/jobs/rebuild/indexlabels";
    ...
    private int gremlinJob() {
        String body = "{" +
                      ...
                      "\"aliases\":{}}";
        String path = "/graphspaces/DEFAULT/graphs/hugegraphapi/jobs/gremlin";
