 ...
 **/
@Slf4j
public class PdConfigureListener implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {
    ...
    private String configFilePath = workDir + fileSeparator + "conf" + fileSeparator + PD_CONFIG_FILE_NAME;
    private String restartShellPath = workDir + fileSeparator + "bin" + fileSeparator
    ...
    public void onApplicationEvent(ApplicationEnvironmentPreparedEvent event) {
        ...
        //    }
        // }
        // Map<String, OriginTrackedValue> appSourceMap = (Map<String, OriginTrackedValue>) appSource
        // .getSource();
    ...
    private void updatePdConfig(MutablePropertySources sources, KvClient client, String pdConfig) throws
                                                                                             PDException,
                                                                                             IOException {
