<<<<<<<< HEAD:hugegraph-pd/hg-pd-test/src/main/java/org/apache/hugegraph/pd/client/PDClientTest.java
/*
...
========
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-test/src/main/java/org/apache/hugegraph/pd/client/PDClientTest.java
...
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-test/src/main/java/org/apache/hugegraph/pd/client/PDClientTest.java
    ...
    public void testMovePartition() {
        ClusterOp.OperationMode mode = ClusterOp.OperationMode.Auto;
        List<ClusterOp.MovePartitionParam> params = new ArrayList<>(1);
        try {
            pdClient.balancePartition();
        } catch (PDException e) {
            e.printStackTrace();
