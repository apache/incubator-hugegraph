<<<<<<<< HEAD:hugegraph-pd/hg-pd-test/src/main/java/org/apache/hugegraph/pd/core/StoreServiceTest.java
/*
...
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-test/src/main/java/org/apache/hugegraph/pd/service/StoreServiceTest.java
...
========
        ...
        final PartitionService partitionService = new PartitionService(pdConfig, new StoreNodeService(pdConfig1),
                new ConfigService(pdConfig1));
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-test/src/main/java/org/apache/hugegraph/pd/service/StoreServiceTest.java
...
========
        final boolean result = service.isOK(DEFAULT_STORE_GROUP_ID);
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-test/src/main/java/org/apache/hugegraph/pd/service/StoreServiceTest.java
...
========
        final List<Metapb.Store> result = service.getActiveStoresByStoreGroup(DEFAULT_STORE_GROUP_ID);
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-test/src/main/java/org/apache/hugegraph/pd/service/StoreServiceTest.java
...
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-test/src/main/java/org/apache/hugegraph/pd/service/StoreServiceTest.java
    ...
    @Test
    public void testUpdateClusterStatus1() throws PDException {
        // Setup
        final Metapb.ClusterStats expectedResult = Metapb.ClusterStats
                .newBuilder().setState(Metapb.ClusterState.Cluster_OK)
                .setMessage("message").setTimestamp(0L).build();
...
========
        final Metapb.ClusterStats result = service.updateClusterStatus(DEFAULT_STORE_GROUP_ID,
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-test/src/main/java/org/apache/hugegraph/pd/service/StoreServiceTest.java
                Metapb.ClusterState.Cluster_OK);
    }

    @Test
    public void testUpdateClusterStatus2() throws PDException {
        // Setup
        final Metapb.ClusterStats expectedResult = Metapb.ClusterStats
                .newBuilder().setState(Metapb.ClusterState.Cluster_OK)
                .setMessage("message").setTimestamp(0L).build();
...
========
        service.checkStoreStatus(DEFAULT_STORE_GROUP_ID);
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-test/src/main/java/org/apache/hugegraph/pd/service/StoreServiceTest.java
