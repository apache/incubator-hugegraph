<<<<<<<< HEAD:hugegraph-pd/hg-pd-common/src/main/java/org/apache/hugegraph/pd/common/HgAssert.java
/*
...
========
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-common/src/main/java/org/apache/hugegraph/pd/common/HgAssert.java
...
public final class HgAssert {
    ...
    public static void isArgumentValid(byte[] bytes, String parameter) {
        assertFalse(isInvalid(bytes), "The argument is invalid: ", parameter);
    }

    public static void isArgumentValid(String str, String parameter) {
        assertFalse(isInvalid(str), "The argument is invalid: ", parameter);
    }

    public static void isArgumentNotNull(Object obj, String parameter) {
        assertTrue(obj != null, "The argument is null: ", parameter);
    }
