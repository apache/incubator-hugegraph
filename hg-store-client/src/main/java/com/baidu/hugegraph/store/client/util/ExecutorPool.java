...
public final class ExecutorPool {
    ...
    public static ThreadPoolExecutor createExecutor(String name, long keepAliveTime, int coreThreads, int maxThreads) {
        return new ThreadPoolExecutor(coreThreads, maxThreads, keepAliveTime, TimeUnit.SECONDS,
                                      ...
                                      newThreadFactory(name), new ThreadPoolExecutor.CallerRunsPolicy()
        );
    }
    ...
    //                                                                       new HgDefaultThreadFactory
    //                                                                       ("store-common"));
    // private final static ExecutorService grpcExecutor = createExecutor("store-grpc", 60L, 600, 10240);
    //// public final static ExecutorService scannerExecutor = createExecutor("scanner", 10l, 200, 1024);
    //
    // static {
