...
public class HgStoreTestUtil {
    ...
    public final static String GRAPH_NAME = "default/hugegraph/g";
    public final static String GRAPH_NAME2 = "default/hugegraph2/g";
    public final static String TABLE_NAME = "unit-table";
    public final static String TABLE_NAME2 = "unit-table-2";
    ...
    public static Map<HgOwnerKey, byte[]> batchPut(HgStoreSession session, String tableName
            , byte[] keyPrefix, int loop, int start, BiFunction<byte[], String, HgOwnerKey> f) {
    ...
    public static int amountIn(List<? extends Iterator> iterators) {
        return iterators.parallelStream().map(e -> HgStoreTestUtil.amountOf(e)).reduce(0, Integer::sum);
    }
    ...
    public static void parallel_test(int threads, Runnable runner, Consumer<Throwable> throwableConsumer) {
    ...
    public static void repeatedly_test(int times, Runnable runner) {
        ...
        metrics.end();
        log.info("*************************************************");
        log.info("*************  Repeatedly Test Completed  **************");
        log.info("Total: {} sec.", metrics.past() / 1000);
        log.info("Repeated: {} times.", times);
