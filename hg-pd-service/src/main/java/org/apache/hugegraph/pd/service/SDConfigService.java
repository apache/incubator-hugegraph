...
public class SDConfigService {
    ...
    private HgMapCache<String, Set<String>> targetsCache = HgMapCache.expiredOf(24 * 60 * 60 * 1000);
        ...
        switch (appName) {
            ...
            default:
                return this.toModels(
                        this.getRegister().getNodes(Query.newBuilder().setAppName(appName).build()));
        }
    }
    ...
    public List<SDConfig> getConfigs(String appName, String path) {
        ...
        switch (appName) {
            ...
            case "store":
                ...
                return Collections.singletonList(config);
            default:
                return toModels(getRegister().getNodes(Query.newBuilder().setAppName(appName).build()));
        }
    }
