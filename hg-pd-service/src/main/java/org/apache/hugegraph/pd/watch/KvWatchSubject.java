<<<<<<<< HEAD:hugegraph-pd/hg-pd-service/src/main/java/org/apache/hugegraph/pd/watch/KvWatchSubject.java
/*
...
========
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-service/src/main/java/org/apache/hugegraph/pd/watch/KvWatchSubject.java
...
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-service/src/main/java/org/apache/hugegraph/pd/watch/KvWatchSubject.java
                    ...
                    if (e instanceof StatusRuntimeException &&
                        ((StatusRuntimeException) e).getStatus().getCode().equals(Status.Code.CANCELLED)) {
                        break;
                    }
                    try {
                        Thread.sleep(100);
