<<<<<<<< HEAD:hugegraph-pd/hg-pd-service/src/main/java/org/apache/hugegraph/pd/rest/RegistryAPI.java
/*
...
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-service/src/main/java/org/apache/hugegraph/pd/rest/RegistryAPI.java
...
public class RegistryAPI extends API {
    ...
    public RegistryRestResponse register(@RequestBody RegistryRestRequest body,
        ...
        try {
            ...
            registryResponse.setErrorType(ErrorType.UNRECOGNIZED);
            registryResponse.setMessage(e.getMessage());
        } catch (PDRuntimeException e) {
            registryResponse = new RegistryRestResponse();
            registryResponse.setErrorType(ErrorType.LICENSE_VERIFY_ERROR);
            registryResponse.setMessage(e.getMessage());
        }
    ...
    public RegistryRestResponse getInfo(@RequestBody RegistryQueryRestRequest body,
        ...
        try {
            ...
            response.setErrorType(ErrorType.OK);
