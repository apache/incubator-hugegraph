...
import com.baidu.hugegraph.store.grpc.Graphpb.Edge;
...
import com.baidu.hugegraph.store.grpc.Graphpb.Variant.Builder;
import com.baidu.hugegraph.store.grpc.Graphpb.VariantType;
import com.baidu.hugegraph.store.grpc.Graphpb.Vertex;
...
public class GraphStoreIterator<T> extends AbstractSelectIterator
    ...
    private ScanPartitionRequest scanRequest;
    ...
    private static Descriptors.FieldDescriptor propertiesDesEdge =
            Edge.getDescriptor().findFieldByNumber(6);
    private static Descriptors.FieldDescriptor propertiesDesVertex =
