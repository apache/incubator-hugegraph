...
public interface DataMover {
    ...
    // 同步副本之间的分区状态
    UpdatePartitionResponse updatePartitionState(Metapb.Partition partition, Metapb.PartitionState state);

    // 同步副本之间分区的范围
    UpdatePartitionResponse updatePartitionRange(Metapb.Partition partition, int startKey, int endKey);
