...
public final class HugeFactoryAuthProxy {
    ...
    private static void registerPrivateActions() {
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.StandardAuthenticator.class, "initAdminUser", "inputPassword", "loginUser");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.HugeGraphAuthProxy.class, "getContext", "lambda$0", "setContext", "access$6", "verifyAdminPermission", "verifyStatusPermission", "verifyPermission", "verifyPermission", "verifySchemaPermission", "verifySchemaPermission", "verifySchemaPermission", "verifySchemaPermission", "verifySchemaExistsPermission", "verifyElemPermission", "verifyElemPermission", "verifyElemPermission", "verifyElemPermission", "verifyResPermission", "verifyUserPermission", "verifyUserPermission", "verifyUserPermission", "getContextString", "access$7", "lambda$1", "lambda$2", "lambda$3", "lambda$4", "lambda$5", "lambda$6", "lambda$7", "lambda$8", "lambda$9", "lambda$10", "lambda$11", "lambda$12", "lambda$13", "lambda$14", "lambda$15", "lambda$16", "lambda$17", "lambda$18", "lambda$19", "lambda$20", "lambda$21", "lambda$22", "lambda$23", "access$2", "access$3", "access$4", "access$5", "resetContext", "logUser");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.auth.HugeGraphAuthProxy.UserManagerProxy.class, "userManager", "this$0");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.HugeGraphAuthProxy.UserManagerProxy.class, "updateCreator", "currentUsername");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.StandardHugeGraph.class, "serializer", "lambda$0", "loadSystemStore", "loadSchemaStore", "loadGraphStore", "closeTx", "analyzer", "access$6", "access$7", "access$2", "access$3", "access$4", "access$5", "waitUntilAllTasksCompleted", "access$8", "loadStoreProvider", "graphTransaction", "schemaTransaction", "openSchemaTransaction", "checkGraphNotClosed", "openSystemTransaction", "openGraphTransaction", "systemTransaction", "access$9", "access$10", "access$11", "access$12", "access$13", "access$14", "access$15", "access$16", "access$17", "access$18");
        ...
        Reflection.registerMethodsToFilter(c("com.baidu.hugegraph.StandardHugeGraph$TinkerpopTransaction"), "resetState", "lambda$0", "lambda$1", "doCommit", "doOpen", "setClosed", "getOrNewTransaction", "setOpened", "verifyOpened", "doRollback", "doClose", "destroyTransaction", "access$0", "access$1", "access$2", "access$3", "graphTransaction", "schemaTransaction", "systemTransaction");
        ...
        Reflection.registerMethodsToFilter(org.apache.tinkerpop.gremlin.structure.util.AbstractTransaction.class, "doCommit", "doOpen", "doRollback", "doClose", "fireOnCommit", "fireOnRollback", "doReadWrite");
        ...
        Reflection.registerMethodsToFilter(c("com.baidu.hugegraph.StandardHugeGraph$Txs"), "access$0", "access$1", "access$2");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.backend.tx.GraphTransaction.class, "indexTx", "addedVertices", "removedVertices", "addedEdges", "removedEdges", "addedProps", "removedProps", "updatedVertices", "updatedEdges", "updatedOldestProps", "locksTable", "checkCustomVertexExist", "checkAdjacentVertexExist", "lazyLoadAdjacentVertex", "ignoreInvalidEntry", "commitPartOfAdjacentEdges", "batchSize", "pageSize", "verticesCapacity", "edgesCapacity", "$assertionsDisabled");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.backend.tx.GraphTransaction.class, "reset", "prepareCommit", "queryVertices", "indexTransaction", "indexTransaction", "beforeWrite", "verticesInTxSize", "edgesInTxSize", "verticesInTxUpdated", "verticesInTxRemoved", "removingEdgeOwner", "prepareAdditions", "prepareDeletions", "prepareDeletions", "prepareUpdates", "commitPartOfEdgeDeletions", "queryVerticesFromBackend", "queryEdgesFromBackend", "verifyVerticesConditionQuery", "verifyEdgesConditionQuery", "optimizeQueries", "optimizeQuery", "indexQuery", "checkVertexLabel", "checkId", "checkAggregateProperty", "checkAggregateProperty", "checkNonnullProperty", "checkVertexExistIfCustomizedId", "lockForUpdateProperty", "filterResultFromIndexQuery", "joinTxVertices", "joinTxEdges", "joinTxRecords", "checkTxVerticesCapacity", "checkTxEdgesCapacity", "propertyUpdated", "parseEntry", "traverseByLabel", "lambda$removeEdges$18", "lambda$removeVertices$17", "lambda$joinTxRecords$16", "lambda$joinTxEdges$15", "lambda$joinTxEdges$14", "lambda$joinTxVertices$13", "lambda$removeEdgeProperty$12", "lambda$addEdgeProperty$11", "lambda$removeVertexProperty$10", "lambda$addVertexProperty$9", "lambda$queryEdgesFromBackend$8", "lambda$queryEdges$7", "lambda$queryEdges$6", "lambda$queryVertices$5", "lambda$queryVertices$4", "lambda$queryAdjacentVertices$3", "lambda$queryAdjacentVertices$2", "lambda$queryNumber$1", "lambda$query$0");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.backend.tx.IndexableTransaction.class, "$assertionsDisabled");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.backend.tx.IndexableTransaction.class, "reset", "commit2Backend", "indexTransaction");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.backend.tx.AbstractTransaction.class, "store", "reset", "params", "commit2Backend", "mutation", "doAction", "prepareCommit", "commitMutation2Backend", "checkOwnerThread", "beforeRead", "autoCommit", "beforeWrite", "afterWrite", "afterRead");
        ...
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.structure.HugeVertex.class, "tx", "label", "name", "edges", "$assertionsDisabled");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.structure.HugeVertex.class, "clone", "clone", "tx", "checkIdLength", "newProperty", "newProperty", "onUpdateProperty", "ensureFilledProperties");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.structure.HugeElement.class, "EMPTY", "MAX_PROPERTIES", "graph", "id", "properties", "removed", "fresh", "propLoaded", "$assertionsDisabled");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.structure.HugeElement.class, "addProperty", "tx", "newProperty", "onUpdateProperty", "ensureFilledProperties", "getIdValue");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.structure.HugeEdge.class, "label", "name", "sourceVertex", "targetVertex", "isOutEdge", "$assertionsDisabled");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.structure.HugeEdge.class, "clone", "clone", "tx", "newProperty", "newProperty", "onUpdateProperty", "ensureFilledProperties", "checkAdjacentVertexExist");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.variables.HugeVariables.class, "setProperty", "createPropertyKey", "createVariableVertex", "removeVariableVertex", "queryVariableVertex", "queryAllVariableVertices", "extractSingleObject");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.schema.SchemaManager.class, "transaction", "graph");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.SchemaManager.class, "checkExists", "lambda$getIndexLabels$3", "lambda$getEdgeLabels$2", "lambda$getVertexLabels$1", "lambda$getPropertyKeys$0");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.PropertyKeyBuilder.class, "checkStableVars", "checkAggregateType", "lambda$create$0");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.schema.builder.AbstractBuilder.class, "transaction", "graph");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.AbstractBuilder.class, "rebuildIndex", "graph", "lockCheckAndCreateSchema", "propertyKeyOrNull", "checkSchemaIdIfRestoringMode", "edgeLabelOrNull", "vertexLabelOrNull", "indexLabelOrNull", "taskWaitTimeout", "checkSchemaName", "validOrGenerateId");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.schema.builder.VertexLabelBuilder.class, "id", "name", "idStrategy", "properties", "primaryKeys", "nullableKeys", "enableLabelIndex", "userdata", "checkExist", "$assertionsDisabled");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.VertexLabelBuilder.class, "checkStableVars", "lambda$create$0", "checkProperties", "checkNullableKeys", "checkIdStrategy", "checkPrimaryKeys");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.schema.builder.EdgeLabelBuilder.class, "id", "name", "sourceLabel", "targetLabel", "frequency", "properties", "sortKeys", "nullableKeys", "enableLabelIndex", "userdata", "checkExist", "$assertionsDisabled");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.EdgeLabelBuilder.class, "checkStableVars", "lambda$create$0", "checkProperties", "checkNullableKeys", "checkSortKeys", "checkRelation");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.schema.builder.IndexLabelBuilder.class, "id", "name", "baseType", "baseValue", "indexType", "indexFields", "userdata", "checkExist", "$assertionsDisabled");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.IndexLabelBuilder.class, "checkStableVars", "checkBaseType", "checkIndexType", "loadElement", "loadElement", "checkFields", "checkFields4Range", "checkRepeatIndex", "checkRepeatIndex", "checkRepeatIndex", "removeSubIndex", "checkPrimaryKeyIndex", "checkRepeatRangeIndex", "checkRepeatSearchIndex", "checkRepeatSecondaryIndex", "checkRepeatShardIndex", "checkRepeatUniqueIndex", "hasSubIndex", "allStringIndex", "oneNumericField", "lambda$createWithTask$0");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.task.TaskManager.class, "instance", "setContext", "closeTaskTx", "lambda$closeTaskTx$0", "resetContext");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.task.StandardTaskScheduler.class, "remove", "submitTask", "initTaskCallable", "queryTask", "queryTask", "queryTask", "lambda$queryTask$7", "lambda$queryTask$6", "lambda$delete$5", "lambda$findTask$4", "lambda$close$3", "lambda$save$2", "lambda$listenChanges$1", "tx", "call", "call", "lambda$null$0", "listenChanges", "unlistenChanges");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.task.HugeTask.class, "set", "result", "status", "property", "scheduler", "scheduler", "done", "callable", "setException", "asArray", "checkDependenciesSuccess", "toOrderSet", "checkPropertySize", "checkPropertySize");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.task.TaskCallable.class, "save", "graph", "done", "task", "cancelled");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.StandardUserManager.class, "cache", "lambda$0", "rolePermission", "rolePermission", "listenChanges", "unlistenChanges", "initSchemaIfNeeded", "invalidCache");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.auth.SchemaDefine.class, "graph", "label");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.SchemaDefine.class, "initProperties", "schema", "unhideField", "hideField", "createPropertyKey", "createPropertyKey", "createPropertyKey", "existVertexLabel", "existEdgeLabel", "createRangeIndex");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.RelationshipManager.class, "save", "graph", "lambda$0", "tx", "toList", "commitOrRollback", "queryRelationship", "unhideLabel", "queryById", "newVertex");
        ...
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.auth.HugeResource.class, "type", "label", "properties", "$assertionsDisabled");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.HugeResource.class, "contains", "filter", "filter", "filter", "matchLabel", "matchProperties", "access$6", "access$0", "access$1", "access$2", "access$3", "access$4", "access$5");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.backend.cache.CacheManager.class, "access$000", "instance", "scheduleTimer");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.license.LicenseVerifier.class, "verifyPublicCert", "initLicenseParam", "buildVerifyParam", "instance");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.traversal.optimize.HugeCountStepStrategy.class, "lambda$apply$0", "instance");
