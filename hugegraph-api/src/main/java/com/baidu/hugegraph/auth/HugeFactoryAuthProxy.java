...
public final class HugeFactoryAuthProxy {
    ...
    private static void registerPrivateActions() {
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.HugeGraphAuthProxy.class, "getContext", "lambda$0", "setContext", "lambda$3", "access$3", "lambda$2", "access$4", "access$2", "lambda$4", "logUser", "lambda$1", "verifyPermission", "verifyPermission", "verifyPermissionAction", "verifyPermissionAction", "verifyRessPermissionAction", "verifyRessPermissionAction", "verifyRessPermissionAction", "verifyRessPermissionAction", "resetContext", "getContextString");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.StandardHugeGraph.class, "lambda$0", "closeTx", "serializer", "loadSystemStore", "loadSchemaStore", "loadGraphStore", "analyzer", "access$3", "access$4", "access$2", "waitUntilAllTasksCompleted", "access$7", "access$5", "access$8", "access$6", "loadStoreProvider", "graphTransaction", "schemaTransaction", "openSchemaTransaction", "checkGraphNotClosed", "openSystemTransaction", "openGraphTransaction", "systemTransaction", "access$9", "access$10", "access$11", "access$12", "access$13", "access$14", "access$15", "access$16", "access$17", "access$18");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.backend.tx.AbstractTransaction.class, "store", "reset", "params", "commit2Backend", "mutation", "prepareCommit", "commitMutation2Backend", "checkOwnerThread", "doAction", "autoCommit", "beforeRead", "beforeWrite", "afterWrite", "afterRead");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.structure.HugeVertex.class, "clone", "clone", "tx", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$IdStrategy", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$HugeKeys", "checkIdLength", "newProperty", "newProperty", "onUpdateProperty", "ensureFilledProperties");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.structure.HugeEdge.class, "clone", "clone", "tx", "checkAdjacentVertexExist", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$HugeKeys", "newProperty", "newProperty", "onUpdateProperty", "ensureFilledProperties", "$SWITCH_TABLE$org$apache$tinkerpop$gremlin$structure$Direction");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.SchemaManager.class, "lambda$0", "checkExists", "lambda$3", "lambda$2", "lambda$1");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.PropertyKeyBuilder.class, "lambda$0", "checkAggregateType", "checkStableVars");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.VertexLabelBuilder.class, "lambda$0", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$Action", "checkStableVars", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$IdStrategy", "checkProperties", "checkNullableKeys", "checkIdStrategy", "checkPrimaryKeys");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.EdgeLabelBuilder.class, "lambda$0", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$Action", "checkStableVars", "checkSortKeys", "checkRelation", "checkProperties", "checkNullableKeys");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.IndexLabelBuilder.class, "lambda$0", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$DataType", "checkStableVars", "$SWITCH_TABLE$com$baidu$hugegraph$type$HugeType", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$IndexType", "checkIndexType", "checkBaseType", "checkFields4Range", "loadElement", "loadElement", "checkFields", "checkRepeatIndex", "checkRepeatIndex", "checkRepeatIndex", "checkPrimaryKeyIndex", "checkRepeatRangeIndex", "checkRepeatSearchIndex", "checkRepeatSecondaryIndex", "checkRepeatShardIndex", "checkRepeatUniqueIndex", "removeSubIndex", "hasSubIndex", "allStringIndex", "oneNumericField");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.task.TaskManager.class, "lambda$0", "instance", "setContext", "resetContext", "closeTaskTx");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.task.StandardTaskScheduler.class, "remove", "lambda$0", "tx", "call", "call", "lambda$3", "lambda$2", "lambda$4", "lambda$1", "listenChanges", "unlistenChanges", "lambda$5", "lambda$6", "lambda$7", "submitTask", "initTaskCallable", "queryTask", "queryTask", "queryTask");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.task.HugeTask.class, "set", "result", "status", "checkPropertySize", "checkPropertySize", "checkDependenciesSuccess", "toOrderSet", "property", "scheduler", "scheduler", "done", "setException", "callable", "asArray");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.SchemaDefine.class, "schema", "existEdgeLabel", "createPropertyKey", "createPropertyKey", "createPropertyKey", "createRangeIndex", "existVertexLabel");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.EntityManager.class, "save", "query", "toList", "queryById", "queryEntity", "tx", "commitOrRollback", "constructVertex");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.RelationshipManager.class, "save", "toList", "queryById", "queryRelationship", "lambda$0", "tx", "commitOrRollback", "newVertex");
