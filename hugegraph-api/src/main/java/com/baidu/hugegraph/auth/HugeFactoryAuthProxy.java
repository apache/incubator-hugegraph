...
public final class HugeFactoryAuthProxy {
    ...
    private static void registerPrivateActions() {
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.HugeFactoryAuthProxy.class, "c", "genRegisterPrivateActions", "registerPrivateActions", "registerPrivateActions", "registerClass");
        ...
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.auth.HugeGraphAuthProxy.class, "LOG", "hugegraph", "taskScheduler", "contexts", "$assertionsDisabled");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.HugeGraphAuthProxy.class, "getContext", "access$2", "access$3", "access$4", "resetContext", "logUser", "lambda$0", "setContext", "verifyAdminPermission", "verifyStatusPermission", "verifyPermission", "verifyPermission", "verifySchemaPermission", "verifySchemaPermission", "verifySchemaPermission", "verifySchemaPermission", "verifySchemaExistsPermission", "verifyElemPermission", "verifyElemPermission", "verifyElemPermission", "verifyElemPermission", "verifyResPermission", "getContextString", "lambda$1", "lambda$2", "lambda$3", "lambda$4", "lambda$5", "lambda$6", "lambda$7", "lambda$8", "lambda$9", "lambda$10", "lambda$11", "lambda$12", "lambda$13", "lambda$14", "lambda$15", "lambda$16", "lambda$17", "lambda$18", "lambda$19", "lambda$20");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.StandardHugeGraph.class, "access$6", "loadStoreProvider", "graphTransaction", "schemaTransaction", "openSchemaTransaction", "checkGraphNotClosed", "openSystemTransaction", "openGraphTransaction", "systemTransaction", "access$7", "access$8", "access$9", "access$10", "access$11", "access$12", "access$13", "access$14", "access$15", "access$16", "access$17", "access$18", "serializer", "loadSystemStore", "loadSchemaStore", "loadGraphStore", "closeTx", "access$2", "access$3", "access$4", "access$5", "lambda$0", "waitUntilAllTasksCompleted", "analyzer");
        ...
        Reflection.registerMethodsToFilter(c("com.baidu.hugegraph.StandardHugeGraph$TinkerpopTransaction"), "resetState", "graphTransaction", "schemaTransaction", "systemTransaction", "access$1", "access$2", "access$3", "lambda$0", "access$0", "setClosed", "doOpen", "getOrNewTransaction", "setOpened", "doCommit", "verifyOpened", "doRollback", "doClose", "destroyTransaction", "lambda$1");
        ...
        Reflection.registerMethodsToFilter(org.apache.tinkerpop.gremlin.structure.util.AbstractTransaction.class, "doOpen", "doCommit", "doRollback", "doClose", "fireOnCommit", "fireOnRollback", "doReadWrite");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.backend.tx.GraphTransaction.class, "reset", "queryVertices", "access$1", "lambda$0", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$IdStrategy", "indexTransaction", "indexTransaction", "beforeWrite", "verticesInTxSize", "edgesInTxSize", "checkTxVerticesCapacity", "checkTxEdgesCapacity", "verticesInTxUpdated", "verticesInTxRemoved", "removingEdgeOwner", "prepareDeletions", "prepareDeletions", "prepareUpdates", "prepareAdditions", "checkVertexExistIfCustomizedId", "checkAggregateProperty", "checkAggregateProperty", "checkNonnullProperty", "queryEdgesFromBackend", "commitPartOfEdgeDeletions", "optimizeQueries", "checkVertexLabel", "checkId", "queryVerticesFromBackend", "joinTxVertices", "joinTxEdges", "lockForUpdateProperty", "verifyVerticesConditionQuery", "verifyEdgesConditionQuery", "optimizeQuery", "indexQuery", "filterResultFromIndexQuery", "joinTxRecords", "propertyUpdated", "parseEntry", "traverseByLabel", "lambda$1", "lambda$2", "lambda$3", "lambda$4", "lambda$5", "lambda$6", "lambda$7", "lambda$8", "lambda$9", "lambda$10", "lambda$11", "lambda$12", "lambda$13", "lambda$14", "lambda$15", "lambda$16", "lambda$17", "prepareCommit");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.backend.tx.AbstractTransaction.class, "store", "reset", "params", "autoCommit", "beforeRead", "beforeWrite", "afterWrite", "afterRead", "commit2Backend", "prepareCommit", "commitMutation2Backend", "mutation", "checkOwnerThread", "doAction");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.structure.HugeVertex.class, "clone", "clone", "tx", "newProperty", "newProperty", "onUpdateProperty", "ensureFilledProperties", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$IdStrategy", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$HugeKeys", "checkIdLength");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.structure.HugeElement.class, "addProperty", "tx", "newProperty", "onUpdateProperty", "ensureFilledProperties", "getIdValue", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$Cardinality");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.structure.HugeEdge.class, "clone", "clone", "tx", "newProperty", "newProperty", "onUpdateProperty", "ensureFilledProperties", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$HugeKeys", "$SWITCH_TABLE$org$apache$tinkerpop$gremlin$structure$Direction", "checkAdjacentVertexExist");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.VertexLabelBuilder.class, "$SWITCH_TABLE$com$baidu$hugegraph$type$define$Action", "lambda$0", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$IdStrategy", "checkStableVars", "checkProperties", "checkNullableKeys", "checkIdStrategy", "checkPrimaryKeys");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.EdgeLabelBuilder.class, "$SWITCH_TABLE$com$baidu$hugegraph$type$define$Action", "checkSortKeys", "checkRelation", "lambda$0", "checkStableVars", "checkProperties", "checkNullableKeys");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.schema.builder.IndexLabelBuilder.class, "$SWITCH_TABLE$com$baidu$hugegraph$type$define$IndexType", "checkBaseType", "checkIndexType", "checkFields4Range", "loadElement", "loadElement", "checkFields", "checkRepeatIndex", "checkRepeatIndex", "checkRepeatIndex", "checkPrimaryKeyIndex", "checkRepeatRangeIndex", "checkRepeatSearchIndex", "checkRepeatSecondaryIndex", "checkRepeatShardIndex", "checkRepeatUniqueIndex", "removeSubIndex", "hasSubIndex", "allStringIndex", "oneNumericField", "lambda$0", "$SWITCH_TABLE$com$baidu$hugegraph$type$define$DataType", "checkStableVars", "$SWITCH_TABLE$com$baidu$hugegraph$type$HugeType");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.task.TaskManager.class, "closeTaskTx", "resetContext", "lambda$0", "setContext", "instance");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.task.StandardTaskScheduler.class, "remove", "submitTask", "initTaskCallable", "queryTask", "queryTask", "queryTask", "tx", "lambda$0", "call", "call", "lambda$1", "lambda$2", "lambda$3", "lambda$4", "lambda$5", "lambda$6", "lambda$7", "listenChanges", "unlistenChanges");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.task.HugeTask.class, "set", "result", "status", "property", "scheduler", "scheduler", "checkPropertySize", "checkPropertySize", "checkDependenciesSuccess", "toOrderSet", "setException", "callable", "done", "asArray");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.task.TaskCallable.class, "save", "graph", "cancelled", "task", "done");
        ...
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.auth.UserManager.class, "CACHE_EXPIRE", "graph", "eventListener", "usersCache", "users", "groups", "targets", "belong", "access", "$assertionsDisabled");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.UserManager.class, "cache", "lambda$0", "listenChanges", "unlistenChanges", "invalidCache");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.auth.SchemaDefine.class, "graph", "label");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.SchemaDefine.class, "initProperties", "schema", "createPropertyKey", "createPropertyKey", "createPropertyKey", "unhideField", "hideField", "existEdgeLabel", "createRangeIndex", "existVertexLabel");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.EntityManager.class, "save", "query", "queryById", "queryEntity", "toList", "tx", "graph", "constructVertex", "commitOrRollback");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.RelationshipManager.class, "save", "queryById", "toList", "tx", "lambda$0", "graph", "newVertex", "queryRelationship", "commitOrRollback");
        ...
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.HugeResource.class, "filter", "filter", "filter", "matchLabel");
        Reflection.registerFieldsToFilter(com.baidu.hugegraph.auth.HugeResource.RolePermission.class, "map");
        Reflection.registerMethodsToFilter(com.baidu.hugegraph.auth.HugeResource.RolePermission.class, "add", "add", "map", "access$0");
    ...
    private static void genRegisterPrivateActions() {
        ...
        registerPrivateActions(HugeResource.RolePermission.class);
