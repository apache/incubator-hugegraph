...
/**
 * 对批量获取 stream response 封装的 iterator，可以做类型的转换，依靠 T -> E 的 mapper
 *  通过调用 invoker，将 server 的结果放到一个队列中。iterator 读取队列的结果
 *  iterator <-------read --------- queue
 *    |                             ↑
