...
public class QueryExecutor {
     ...
     */
    private List<HgKvIterator<BaseElement>> getSimpleIterator(StoreQueryParam query) throws PDException {
     ...
     */
    private List<HgKvIterator<BaseElement>> getCountIterator(StoreQueryParam query) throws PDException {
