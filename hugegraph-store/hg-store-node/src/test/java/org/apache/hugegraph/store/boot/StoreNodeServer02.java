...
public class StoreNodeServer02 {

    public static void main(String[] args) {
        // deleteDir(new File("tmp/8502"));
        String logPath = System.getProperty("logging.path");
        if (StringUtils.isBlank(logPath)) {
            System.setProperty("logging.path", "logs/8502");
        ...
        SpringApplication.run(StoreNodeApplication.class, "--spring.profiles.active=server02");
        System.out.println("StoreNodeServer02 started.");
    }
