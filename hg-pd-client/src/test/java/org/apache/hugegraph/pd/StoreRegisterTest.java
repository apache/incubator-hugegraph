<<<<<<<< HEAD:hugegraph-pd/hg-pd-test/src/main/java/org/apache/hugegraph/pd/client/StoreRegisterTest.java
/*
...
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-client/src/test/java/org/apache/hugegraph/pd/StoreRegisterTest.java
...
========
        Pulse pdPulse = pdClient.getPulse();

        PulseNotifier<PartitionHeartbeatRequest.Builder> notifier = pdPulse.connect(
                new PulseListener<PulseResponse>() {
>>>>>>>> d7e3d51dd (3.6.5 -> 4.x diff):hg-pd-client/src/test/java/org/apache/hugegraph/pd/StoreRegisterTest.java
