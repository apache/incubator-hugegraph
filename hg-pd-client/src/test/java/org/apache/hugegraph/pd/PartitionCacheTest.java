...
public class PartitionCacheTest {
    ...
    public void test(){
        ...
        for(int i = 0; i< 10; i++) {
            KVPair<Metapb.Partition, Metapb.Shard> partShards = new KVPair<>(Metapb.Partition.newBuilder()
                    .setStartKey(i*10)
                    .setEndKey((i+1)*10)
                    .build(),null);
    ...
    public void test1(){
        ...
        Map<String, RangeMap<Long, Integer>> keyToPartIdCache2 = cloneKeyToPartIdCache(keyToPartIdCache);
        System.out.println(keyToPartIdCache2.size());
    }

    public Map<String, RangeMap<Long, Integer>> cloneKeyToPartIdCache(Map<String, RangeMap<Long, Integer>> cache) {
